...
public class SQLOperation {
	...
	public static void recalculateEntireHL4History(int seqIndex) {
		...
		try {
			...
			while (en.hasMoreElements()) {
				...
				SQLOperation.calculateCBullHistoryNew(symbol, seqIndex, true);
				SQLOperation.calculateCBullHistoryNew(symbol, seqIndex, false);
				SQLOperation.calculateHL4History(symbol, seqIndex);
				SQLOperation.markHL4Result(symbol, seqIndex);
	...
	public static void calculatePTMAV(String symbol, int seqIndex) {
		...
		try {
			...
			SQL = "select  TMAV,seqindex from  BPMADMIN.YAHOODB   where symbol='"
					+ symbol + "' and TMAV>0.001 AND SEQINDEX>="+(seqIndex-50)+" order by seqIndex desc";
			...
			while (rs1.next()) {
				...
				if (a == Calendar.FRIDAY&&index1==0) {
				 //System.out.println("Friday.");
					 ...
					 //System.out.println("Friday.");
					 String line="Things look weird between "+index1+"("+date1+") and "+index2+"("+date2+")";
					 ...
					 if(index1>0){
						 if((index1-index2)==4){
							 ...
							 String line=" Weekly "+yield +" yield between "+index1+"("+date1+") and "+index2+"("+date2+")";
							 System.out.println(line);
							 Files.appendToIPOBullFile(line);
							 index1 = 0;
							 price1 = 0.0f; 
				...
				if (a == Calendar.FRIDAY) {
				 ...
				 if(indexFriday1==0){
					 ...
					 if((indexFriday1-indexFriday2)==7){
						 float yield = 100.0f*(priceFriday1 - priceFriday2)/priceFriday2;
						 String line=" Weekly "+yield +" yield between "+indexFriday1+"("+date1+") and "+indexFriday2+"("+date2+")";
						 System.out.println(line);
						 Files.appendToIPOBullFile(line);
						 ...
						 String line="Things look weird between "+indexFriday1+"("+date1+") and "+indexFriday2+"("+date2+")";
						 System.out.println(line);
						 Files.appendToIPOBullFile(line);
						 indexFriday1 = indexFriday2;
						 priceFriday1 = priceFriday2; 
