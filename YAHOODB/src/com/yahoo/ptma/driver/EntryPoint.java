...
public class EntryPoint {
	...
	public static void CASE1(int seqIndex) {
		...
		Hashtable ystocks1 = SQLOperation.getCurrentYahooStocks(seqIndex);
		...
		// CHAT<0 AND PTMA>0 CORRECTION CASE, GAP>20 DAYS
		...
		// sample data 3027 at 10620, YahooDB back to beginning of each stock
		/*
		...
		// AND USE SUM(PTMA) AVERAGE DURING CBULL NEGATIVE >5.0F AS STANDARD
	...
	// PTMA>50.0,ADJUSTEDPRICE>10 AND VOLUME>500000 AND CBULL<60
	// and count (PTMA>50%)==0 FOR LAST 120 DAYS, MARKET CAP >1000 M
	// TEST DATA RANGE W>5000 AND W<10677-250
...
//	Finish processing case 10, total time cost in hours 0.11097861
	...
	//		+ seqIndex + " AND ADJUSTEDPRICE>10 AND VOLUME>500000 AND CBULL>-60
...
//	Average max loss -55.47877
	...
	// ADJUSTEDPRICE>10 AND VOLUME>500000 AND CBULL<-29, w > 5000
	// if (ptma > 8.0f) {
