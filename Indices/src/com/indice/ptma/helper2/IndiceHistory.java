...
public class IndiceHistory {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("sleeping after ^N225");
		...
		try {
			...
			String dateString = "07-31-2020";
			//daily one file
			//Hashtable records = Files.parseInvestingCom(dateString);
			//history , you need to download each index history file
			//also give FSTE related three index propernames
			//
			Hashtable records = Files.parseInvestingComHistory(dateString);

			Enumeration en = records.keys();
			while (en.hasMoreElements()) {
				String key = en.nextElement().toString();
				// delete record at 5/10/2019, remove this line afterwards
				// SQLOperation.deleteSingleRecord(key, 43594);
				// reset all calculated fields to 0
				// SQLOperation.resetAllCalculatedFields(key);
		...
		Hashtable indices = Files.getTrackedIndex();
