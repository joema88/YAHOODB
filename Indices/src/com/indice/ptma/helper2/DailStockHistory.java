...
public class DailStockHistory {
	...
	public static void main(String[] args) {
		...
		doEODRunNew("20180525", skipIndex, calAVGlmdr);
	...
	public static void doEODRunNew(String date, boolean skipTopOff,
		...
		SQLOperationStatus.addWorkingDays(com.intraday.ptma.helper.StaticData.getDownloadDays());
	...
	if (Files.intradayDoneFile()) {
	        ...
	        //cut and paste this content to com.intraday.ptma.helper.StaticData.java
	        //excluded stocks map
