...
public class HttpDownload {
	...
	public static void main(String[] args) {
		...
		try{
			downLoadYahooIndexHistory("^FTSE");
...
public static String  downTodayIndicePage(String dateString) throws Exception{
		...
		try {
		   ...
		   // EntityUtils.consume(entity1);
		    ...
		    String filePath = "C:\\stock\\yahoo\\indices\\"+fileName;
